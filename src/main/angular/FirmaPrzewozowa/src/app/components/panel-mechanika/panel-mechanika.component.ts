...
export class PanelMechanikaComponent implements OnInit {
  ...
  oneBus: AutobusModel = {id :0, przebieg:0, zasieg:0, iloscMiejsc:0, rokProdukcji:0, model: "", mocNetto:0, iloscPakietowZasilajacych: undefined, poziomNaladowania: undefined}
