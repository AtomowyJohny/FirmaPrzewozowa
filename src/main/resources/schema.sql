...
-- Last modification date: 2024-01-27 14:01:41.105
...
CREATE TABLE Akumulator (
    ...
    CHECK (Pojemnosc <= 100 AND Pojemnosc >= 0),
...
CREATE TABLE Dyspozytor (
    ID_Pracownika_Dyspozytora int  NOT NULL,
    CONSTRAINT Dyspozytor_pk PRIMARY KEY (ID_Pracownika_Dyspozytora)
);
...
CREATE TABLE Dyspozytor_W_Autobusie (
    ID_Pracownika_Dyspozytora int  NOT NULL,
    ID_Autobusu int  NOT NULL,
    CONSTRAINT Dyspozytor_W_Autobusie_pk PRIMARY KEY (ID_Pracownika_Dyspozytora,ID_Autobusu)
);
...
CREATE TABLE Mechanik (
    Pracownik_ID_Mechanika int  NOT NULL,
    Stopien_Doswiadczenia int  NOT NULL,
    Dodatek_Do_Premii_Za_Doswiadczenie int  NOT NULL,
    Premia int  NOT NULL,
    CONSTRAINT Mechanik_pk PRIMARY KEY (Pracownik_ID_Mechanika)
);
...
CREATE TABLE Pracownik_W_Zajezdni (
    ...
    Data_Od int  NOT NULL,
    Data_Do int  NOT NULL,
...
ALTER TABLE AkumulatoryAutobusu ADD CONSTRAINT AkumulatoryAutobusu_Akumulator FOREIGN KEY AkumulatoryAutobusu_Akumulator (ID_Akumulatora)
    REFERENCES Akumulator (ID_Akumulatora);

-- Reference: AkumulatoryAutobusu_Autobus_Elektryczny (table: AkumulatoryAutobusu)
ALTER TABLE AkumulatoryAutobusu ADD CONSTRAINT AkumulatoryAutobusu_Autobus_Elektryczny FOREIGN KEY AkumulatoryAutobusu_Autobus_Elektryczny (ID_Autobusu_Elektryczny)
    REFERENCES Autobus_Elektryczny (ID_Autobusu_Elektryczny);

-- Reference: Autobus_Elektryczny_Autobus (table: Autobus_Elektryczny)
ALTER TABLE Autobus_Elektryczny ADD CONSTRAINT Autobus_Elektryczny_Autobus FOREIGN KEY Autobus_Elektryczny_Autobus (ID_Autobusu_Elektryczny)
    REFERENCES Autobus (ID_Autobusu);

-- Reference: Autobus_Hybrydowy_Autobus_Elektryczny (table: Autobus_Hybrydowy)
ALTER TABLE Autobus_Hybrydowy ADD CONSTRAINT Autobus_Hybrydowy_Autobus_Elektryczny FOREIGN KEY Autobus_Hybrydowy_Autobus_Elektryczny (ID_Autobusu_Elektryczny)
    REFERENCES Autobus_Elektryczny (ID_Autobusu_Elektryczny);

-- Reference: Autobus_Hybrydowy_Autobus_Silnikowy (table: Autobus_Hybrydowy)
ALTER TABLE Autobus_Hybrydowy ADD CONSTRAINT Autobus_Hybrydowy_Autobus_Silnikowy FOREIGN KEY Autobus_Hybrydowy_Autobus_Silnikowy (ID_Autobusu_Silnikowy)
    REFERENCES Autobus_Silnikowy (ID_Autobusu_Silnikowy);

-- Reference: Autobus_Miedzymiastowy_Autobus (table: Autobus_Miedzymiastowy)
ALTER TABLE Autobus_Miedzymiastowy ADD CONSTRAINT Autobus_Miedzymiastowy_Autobus FOREIGN KEY Autobus_Miedzymiastowy_Autobus (ID_Autobusu_Miedzymiastowy)
    REFERENCES Autobus (ID_Autobusu);

-- Reference: Autobus_Miejski_Autobus (table: Autobus_Miejski)
ALTER TABLE Autobus_Miejski ADD CONSTRAINT Autobus_Miejski_Autobus FOREIGN KEY Autobus_Miejski_Autobus (ID_Autobusu_Miejski)
    REFERENCES Autobus (ID_Autobusu);

-- Reference: Autobus_Miejski_Miasto (table: Autobus_Miejski)
ALTER TABLE Autobus_Miejski ADD CONSTRAINT Autobus_Miejski_Miasto FOREIGN KEY Autobus_Miejski_Miasto (ID_Miasta)
    REFERENCES Miasto (ID_Miasta);

-- Reference: Autobus_Silnikowy_Autobus (table: Autobus_Silnikowy)
ALTER TABLE Autobus_Silnikowy ADD CONSTRAINT Autobus_Silnikowy_Autobus FOREIGN KEY Autobus_Silnikowy_Autobus (ID_Autobusu_Silnikowy)
    REFERENCES Autobus (ID_Autobusu);

-- Reference: Autobus_W_Miescie_Autobus_Miedzymiastowy (table: Autobus_W_Miescie)
ALTER TABLE Autobus_W_Miescie ADD CONSTRAINT Autobus_W_Miescie_Autobus_Miedzymiastowy FOREIGN KEY Autobus_W_Miescie_Autobus_Miedzymiastowy (ID_Autobusu_Miedzymiastowy)
    REFERENCES Autobus_Miedzymiastowy (ID_Autobusu_Miedzymiastowy);

-- Reference: Autobus_W_Miescie_Miasto (table: Autobus_W_Miescie)
ALTER TABLE Autobus_W_Miescie ADD CONSTRAINT Autobus_W_Miescie_Miasto FOREIGN KEY Autobus_W_Miescie_Miasto (ID_Miasta)
    REFERENCES Miasto (ID_Miasta);

-- Reference: Dyspozytor_Pracownik (table: Dyspozytor)
ALTER TABLE Dyspozytor ADD CONSTRAINT Dyspozytor_Pracownik FOREIGN KEY Dyspozytor_Pracownik (ID_Pracownika_Dyspozytora)
    REFERENCES Pracownik (ID_Pracownika);

-- Reference: Dyspozytor_W_Autobusie_Autobus (table: Dyspozytor_W_Autobusie)
ALTER TABLE Dyspozytor_W_Autobusie ADD CONSTRAINT Dyspozytor_W_Autobusie_Autobus FOREIGN KEY Dyspozytor_W_Autobusie_Autobus (ID_Autobusu)
    REFERENCES Autobus (ID_Autobusu);

-- Reference: Dyspozytor_W_Autobusie_Dyspozytor (table: Dyspozytor_W_Autobusie)
ALTER TABLE Dyspozytor_W_Autobusie ADD CONSTRAINT Dyspozytor_W_Autobusie_Dyspozytor FOREIGN KEY Dyspozytor_W_Autobusie_Dyspozytor (ID_Pracownika_Dyspozytora)
    REFERENCES Dyspozytor (ID_Pracownika_Dyspozytora);

-- Reference: Kierowca_Autobus (table: Kierowca)
ALTER TABLE Kierowca ADD CONSTRAINT Kierowca_Autobus FOREIGN KEY Kierowca_Autobus (ID_Autobusu)
    REFERENCES Autobus (ID_Autobusu);

-- Reference: Kierowca_Pracownik (table: Kierowca)
ALTER TABLE Kierowca ADD CONSTRAINT Kierowca_Pracownik FOREIGN KEY Kierowca_Pracownik (ID_Kierowcy)
    REFERENCES Pracownik (ID_Pracownika);

-- Reference: Kurs_Autobus (table: Kurs)
ALTER TABLE Kurs ADD CONSTRAINT Kurs_Autobus FOREIGN KEY Kurs_Autobus (ID_Autobusu)
    REFERENCES Autobus (ID_Autobusu);

-- Reference: Mechanik_Pracownik (table: Mechanik)
ALTER TABLE Mechanik ADD CONSTRAINT Mechanik_Pracownik FOREIGN KEY Mechanik_Pracownik (Pracownik_ID_Mechanika)
    REFERENCES Pracownik (ID_Pracownika);

-- Reference: Mechanik_W_Autobusie_Autobus (table: Mechanik_W_Autobusie)
ALTER TABLE Mechanik_W_Autobusie ADD CONSTRAINT Mechanik_W_Autobusie_Autobus FOREIGN KEY Mechanik_W_Autobusie_Autobus (ID_Autobusu)
    REFERENCES Autobus (ID_Autobusu);

-- Reference: Mechanik_W_Autobusie_Mechanik (table: Mechanik_W_Autobusie)
ALTER TABLE Mechanik_W_Autobusie ADD CONSTRAINT Mechanik_W_Autobusie_Mechanik FOREIGN KEY Mechanik_W_Autobusie_Mechanik (ID_Mechanika)
    REFERENCES Mechanik (Pracownik_ID_Mechanika);

-- Reference: Pracownik_W_Zajezdni_Pracownik (table: Pracownik_W_Zajezdni)
ALTER TABLE Pracownik_W_Zajezdni ADD CONSTRAINT Pracownik_W_Zajezdni_Pracownik FOREIGN KEY Pracownik_W_Zajezdni_Pracownik (ID_Pracownika)
    REFERENCES Pracownik (ID_Pracownika);

-- Reference: Pracownik_W_Zajezdni_Zajezdnia (table: Pracownik_W_Zajezdni)
ALTER TABLE Pracownik_W_Zajezdni ADD CONSTRAINT Pracownik_W_Zajezdni_Zajezdnia FOREIGN KEY Pracownik_W_Zajezdni_Zajezdnia (ID_Zajezdni)
    REFERENCES Zajezdnia (ID_Zajezdni);

-- Reference: Przystanek_W_Kursie_Kurs (table: Przystanek_W_Kursie)
ALTER TABLE Przystanek_W_Kursie ADD CONSTRAINT Przystanek_W_Kursie_Kurs FOREIGN KEY Przystanek_W_Kursie_Kurs (ID_Kursu)
    REFERENCES Kurs (ID_Kursu);

-- Reference: Przystanek_W_Kursie_Przystanek (table: Przystanek_W_Kursie)
ALTER TABLE Przystanek_W_Kursie ADD CONSTRAINT Przystanek_W_Kursie_Przystanek FOREIGN KEY Przystanek_W_Kursie_Przystanek (ID_Przystanku)
    REFERENCES Przystanek (ID_Przystanku);

-- Reference: Zajezdnia_Przystanek (table: Zajezdnia)
ALTER TABLE Zajezdnia ADD CONSTRAINT Zajezdnia_Przystanek FOREIGN KEY Zajezdnia_Przystanek (ID_Zajezdni)
    REFERENCES Przystanek (ID_Przystanku);
